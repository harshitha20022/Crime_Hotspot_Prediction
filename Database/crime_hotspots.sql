...
--
-- Host: localhost
-- Generation Time: Jan 11, 2021 at 12:36 PM
...
--
-- Database: `crime_hotspots`
--
CREATE DATABASE IF NOT EXISTS `crime_hotspots` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `crime_hotspots`;
...
--
-- Table structure for table `remote_user_crime_hotspots_model`
--

CREATE TABLE IF NOT EXISTS `remote_user_crime_hotspots_model` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `City` varchar(300) NOT NULL,
  `names` varchar(300) NOT NULL,
  `population` varchar(300) NOT NULL,
  `Hotspot_Name` varchar(300) NOT NULL,
  `Street_name` varchar(300) NOT NULL,
  `Address` varchar(300) NOT NULL,
  `Crime_Type` varchar(300) NOT NULL,
  `Number_Of_Crimes` int(11) NOT NULL,
  `Crime_Evidence` varchar(300) NOT NULL,
  `Action_Taken` varchar(300) NOT NULL,
  `Crime_DateTime` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
...
--
-- Table structure for table `remote_user_crime_ratio_model`
--

CREATE TABLE IF NOT EXISTS `remote_user_crime_ratio_model` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `names` varchar(300) NOT NULL,
